...
var getPlatform = function () {
    ...
    var userAgent = window.navigator.userAgent,
        // @ts-ignore
        platform =
            (userAgentData === null || userAgentData === void 0
                ? void 0
        ...
        Object.defineProperty(window, "fetch", {
            ...
            get: function () {
                ...
                return function (url, options) {
                    ...
                    var stack = new Error().stack;
                    _this._isUrlInIgnoreList = self.isUrlInIgnoreList(
                        _this._url
                    );
    ...
    ErrorInterceptor.prototype.init = function () {
        ...
        window.addEventListener(
            ...
            function (event) {
                errorEmit({
                    type: "Error",
                    name: "Promise Error",
                    data: { reason: event.reason, url: window.location.href },
                });
            },
            true
        );
        ...
        console.error = function (error) {
            errorEmit({
                type: "Error",
                name: "Console Error",
                data: { reason: error, url: window.location.href },
            });
